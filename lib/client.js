...
// Performs a call to the long routing endpoints and do not wait for finish
Routific.prototype.startRoute = function(problem, cb) {
  var self = this;
  var routeEndpoint = problem.constructor.routingLongEndpoint;
  postRequest(self, routeEndpoint, problem.data, cb);
};
